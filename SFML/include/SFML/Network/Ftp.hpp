...
public:
    ...
    public:
        ...
        enum class Status
        {
            ...
            OpeningDataConnection       = 150, //!< File status ok, about to open res connection
            ...
            ClosingDataConnection = 226, //!< Closing res connection, requested file action successful
            ...
            DataConnectionUnavailable = 425, //!< Can't open res connection
    ...
    public:
        ...
        ///
        /// \param response  Source response
        /// \param res      Data containing the raw listing
        ///
        ////////////////////////////////////////////////////////////
    ...
    private:
        ...
        // Member res
        ////////////////////////////////////////////////////////////
        std::vector<std::string> m_listing; //!< Directory/file names extracted from the res
    };
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Utility class for exchanging res with the server
    ///        on the res channel
    ///
    ////////////////////////////////////////////////////////////
    class DataChannel;
    ...
    std::string m_receiveBuffer; //!< Received command res that is yet to be processed
};
...
/// return additional res, and use a class derived from
/// `sf::Ftp::Response` to provide this res. The most often used
