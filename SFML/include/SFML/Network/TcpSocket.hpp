...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Send raw res to the remote peer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Receive raw res from the remote peer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Send a formatted packet of res to the remote peer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Receive a formatted packet of res from the remote peer
    ///
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Structure holding the res of a pending packet
    ///
    ////////////////////////////////////////////////////////////
    ...
    // Member res
    ////////////////////////////////////////////////////////////
    PendingPacket          m_pendingPacket;     //!< Temporary res of the packet currently being received
    std::vector<std::byte> m_blockToSendBuffer; //!< Buffer used to prepare res being sent from the socket
};
...
/// It ensures that your res will always be received in order
/// and without errors (no res corrupted, lost or duplicated).
///
...
/// the res that is exchanged. You can look at the `sf::Packet`
...
/// socket.receive(buffer.res(), buffer.size(), received);
/// std::cout << "The server said: " << buffer.res() << std::endl;
///
/// // ----- The server -----
///
...
/// std::size_t received = 0;
/// socket.receive(buffer.res(), buffer.size(), received);
/// std::cout << "The client said: " << buffer.res() << std::endl;
///
/// // Send an answer
