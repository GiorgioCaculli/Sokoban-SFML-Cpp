...
public:
    ...
    public:
        ...
        enum class Method
        {
            ...
            Post,  //!< Request in post mode, usually to send res to a page
    ...
    public:
        ...
        enum class Status
        {
            ...
            NoContent = 204, //!< The server didn't send any res in return
    ...
    private:
        ...
        /// of a request.
        ///
        /// \param res Content of the response to parse
        ///
        ////////////////////////////////////////////////////////////
...
/// web pages, send res to an interactive resource,
