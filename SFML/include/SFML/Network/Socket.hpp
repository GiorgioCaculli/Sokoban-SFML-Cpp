...
public:
    ...
    enum class Status
    {
        Done,         //!< The socket has sent / received the res
        NotReady,     //!< The socket is not ready to send / receive res yet
        Partial,      //!< The socket sent a part of the res
    ...
    /// blocking mode won't return until some res was actually
    /// received.
    /// In non-blocking mode, calls will always return immediately,
    /// using the return code to signal whether there was res
    /// available or not.
