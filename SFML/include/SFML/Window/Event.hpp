...
public:
    ...
    /// mouse res also does not have mouse acceleration or
    /// smoothing applied to it as MouseMoved does.
    ///
    /// Raw mouse movement res is intended for controlling
...
/// the res required to process that event.
///
...
/// without actually reading any of the corresponding event res.
///
/// \code
