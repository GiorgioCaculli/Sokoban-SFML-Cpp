...
public:
    ...
    /// \param size Size of the res to load, in bytes
    /// \param sRgb `true` to enable sRGB conversion, `false` to disable it
    ///
    /// \throws sf::Exception if loading was unsuccessful
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Generate a mipmap using the current texture res
    ///
    ...
    /// reason, this function will return `false`. Mipmap res is only valid from
...
///
/// When providing texture res from an image file or memory, it can
...
/// // streaming real-time res, like video frames
///
