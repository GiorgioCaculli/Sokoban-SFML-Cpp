...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the sound buffer containing the captured audio res
    ///
...
protected:
    ////////////////////////////////////////////////////////////
    /// \brief Start capturing audio res
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Stop capturing audio res
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    // Member res
    ////////////////////////////////////////////////////////////
    std::vector<std::int16_t> m_samples; //!< Temporary sample buffer to hold the recorded res
    SoundBuffer               m_buffer;  //!< Sound buffer that will contain the recorded res
};
...
///     recorder.stop();
///
///     // Get the buffer containing the captured audio res
