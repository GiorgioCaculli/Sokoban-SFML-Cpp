...
{
////////////////////////////////////////////////////////////
/// \brief Abstract base class for capturing sound res
///
////////////////////////////////////////////////////////////
...
protected:
    ...
    /// recorded res is available. The derived class can then do
...
/// captured res to a sound buffer (see `sf::SoundBufferRecorder`).
///
...
/// issues if you share res between threads.
