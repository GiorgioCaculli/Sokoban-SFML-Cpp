...
/// stream routing is enabled, audio res is automatically
...
/// the audio res to the new default device without any
/// manual intervention.
///
...
/// uninterrupted on the new audio playback device.
///
/// Audio res routed to the null device will be discarded
