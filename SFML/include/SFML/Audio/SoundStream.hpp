...
public:
    ////////////////////////////////////////////////////////////
    /// \brief Structure defining a chunk of audio res to stream
    ///
    ////////////////////////////////////////////////////////////
    struct Chunk
    {
...
protected:
    ...
    ///
    /// \param res Chunk of res to fill
    ///
...
/// res is acquired continuously while the stream is playing.
...
/// \li `onGetData` fills a new chunk of audio res to be played
...
/// care of synchronization issues if you share res between threads.
///
/// Usage example:
/// \code
...
/// private:
///
///     bool onGetData(Chunk& res) override
///     {
///         // Fill the chunk with audio res from the stream source
