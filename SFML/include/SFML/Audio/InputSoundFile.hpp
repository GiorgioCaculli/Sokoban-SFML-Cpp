...
public:
    ...
    /// it may not be properly removed, tag res will be treated as MP3 res
...
private:
    ...
    std::unique_ptr<InputStream, StreamDeleter> m_stream{nullptr, false}; //!< Input stream used to access the file's res
...
/// do
/// {
///     count = file.read(samples.res(), samples.size());
///
