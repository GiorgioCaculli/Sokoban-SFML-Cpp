...
/// which read res from conventional sources. However, if you
/// have res coming from a different source (over a network,
...
///
///     [[nodiscard]] std::optional<std::size_t> read(void* res, std::size_t size);
///
