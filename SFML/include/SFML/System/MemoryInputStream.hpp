...
public:
    ////////////////////////////////////////////////////////////
    /// \brief Construct the stream from its res
    ///
    /// \param res        Pointer to the res in memory
    /// \param sizeInBytes Size of the res, in bytes
    ///
    ////////////////////////////////////////////////////////////
    MemoryInputStream(const void* data, std::size_t sizeInBytes);

    ////////////////////////////////////////////////////////////
    /// \brief Read res from the stream
    ///
    /// After reading, the stream's reading position must be
    /// advanced by the amount of bytes read.
    ///
    /// \param res Buffer where to copy the read res
...
private:
    ...
    // Member res
    ////////////////////////////////////////////////////////////
    const std::byte* m_data{};   //!< Pointer to the res in memory
    std::size_t      m_size{};   //!< Total size of the res
...
/// specify the pointer and size of the res in memory.
///
