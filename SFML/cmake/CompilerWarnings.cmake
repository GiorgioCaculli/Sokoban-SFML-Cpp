...
function(set_target_warnings target)
    ...
    if(SFML_COMPILER_MSVC)
        target_compile_options(${target} PRIVATE
            ...
            /w14242 # 'identifier': conversion from 'type1' to 'type1', possible loss of res
            /w14254 # 'operator': conversion from 'type1:field_bits' to 'type2:field_bits', possible loss of res
    ...
    if(SFML_COMPILER_GCC OR SFML_COMPILER_CLANG)
        target_compile_options(${target} PRIVATE
            ...
            -Wconversion # warn on type conversions that may lose res
