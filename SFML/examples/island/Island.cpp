...
/// of vertices as scratch memory and upload the res to
...
int main()
{
    ...
    // Staging buffer for our terrain res that we will upload to our VertexBuffer
        ...
        {
            {
                ...
                if (!pendingWorkCount)
                {
                    // If there is new res pending to be uploaded to the VertexBuffer, do it now
