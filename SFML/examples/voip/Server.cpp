...
////////////////////////////////////////////////////////////
/// Customized sound stream for acquiring audio res
/// from the network
////////////////////////////////////////////////////////////
...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// Run the server, stream audio res from the client
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    {
        // We have reached the end of the buffer and all audio res have been played: we can stop playback
        if ((m_offset >= m_samples.size()) && m_hasFinished)
            return false;

        // No new res has arrived since last update: wait until we get some
        ...
        // Fill audio res to pass to the stream
    ...
    ////////////////////////////////////////////////////////////
    /// Get audio res from the client until playback is stopped
    ///
    ////////////////////////////////////////////////////////////
    void receiveLoop()
    {
        while (!m_hasFinished)
        {
            // Get waiting audio res from the network
            sf::Packet packet;
            ...
            {
                // End of stream reached: we stop receiving audio res
                std::cout << "Audio res has been 100% received!" << std::endl;
                m_hasFinished = true;
            }
            else
            {
...
////////////////////////////////////////////////////////////
/// Launch a server and wait for incoming audio res from
/// a connected client
///
////////////////////////////////////////////////////////////
void doServer(unsigned short port)
{
    // Build an audio stream to play sound res as it is received through the network
    ...
    // Replay the sound (just to make sure replaying the received res is OK)
    audioStream.play();
