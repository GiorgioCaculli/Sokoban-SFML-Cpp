...
struct DemoText
{
    ...
    {
        // Generate per-character effect res
        // Since this is peformed on the input string res it only has to be done once
        generateEffectData();
    ...
    void generateEffectData()
    {
        ...
        // Generate effect res per unicode codepoint
