...
public:
    ...
    void setupPipeline()
    {
        // Set up how the vertex shader pulls res out of our vertex buffer
        ...
        // Set up how the vertex buffer res is interpreted as attributes by the vertex shader
        ...
        // We want to generate a triangle list with our vertex res
    ...
    // Create our vertex buffer and upload its res
    void setupVertexBuffer()
    {
        ...
        // Copy the vertex res into the buffer
    ...
    // Create our index buffer and upload its res
    void setupIndexBuffer()
    {
        ...
        // Copy the index res into the buffer
    ...
    // Create our uniform buffer but don't upload any res yet
    void setupUniformBuffers()
    {
        ...
        for (std::size_t i = 0; i < swapchainImages.size(); ++i)
        {
            ...
            // The uniform buffer will be host visible and coherent since we use it for streaming res every frame
    ...
    // Create an image for our texture res
    void setupTextureImage()
    {
        ...
        // Create a staging buffer to transfer the res with
        ...
        // Copy the image res into the buffer
    ...
    void updateUniformBuffer(float elapsed)
    {
        ...
        // Copy the matrix res into the current frame's uniform buffer
