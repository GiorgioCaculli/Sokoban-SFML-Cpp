...
int main()
{
    ...
    // Here we'll use an integrated custom recorder, which saves the captured res into a SoundBuffer
    ...
    // Get the buffer containing the captured res
    ...
    // Choose what to do with the recorded sound res
    char choice = 0;
